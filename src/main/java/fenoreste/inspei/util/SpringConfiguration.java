...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",transactionManagerRef = "transactionManager",basePackages = "fenoreste.inspei.dao")
@Service
public class SpringConfiguration {	
	...
	public LocalContainerEntityManagerFactoryBean entity(){
		...
		em.setPackagesToScan("fenoreste.inspei.entity");		
